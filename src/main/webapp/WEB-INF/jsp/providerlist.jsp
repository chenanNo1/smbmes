...
<div class="right">
	...
	<div class="search">
		<form method="get"
			action="${pageContext.request.contextPath }/provider.html">
			...
			<tr>
				...
				<td><span><a class="viewProvider" href="javascript:;"
						proid=${provider.id } proname=${provider.proName }><img
							...
							alt="查看" title="查看" /></a></span> <span><a class="modifyProvider"
...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/js/providerlist.js"></script>
