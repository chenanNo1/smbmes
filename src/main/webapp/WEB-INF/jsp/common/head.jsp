	...
	<section class="publicMian ">
		<div class="left">
			...
			<nav>
				<ul class="list">
					<li><a
						href="${pageContext.request.contextPath }/bill.html">订单管理</a></li>
					<li><a
						href="${pageContext.request.contextPath }/provider.html">供应商管理</a></li>
					<li><a href="${pageContext.request.contextPath }/user.html">用户管理</a></li>
					<li><a href="${pageContext.request.contextPath }/pwd.html">密码修改</a></li>
					<li><a
						href="${pageContext.request.contextPath }/login.html">退出系统</a></li>
				</ul>
			</nav>
		</div>
